...
<body>
    <div class="container">
        ...
        <form action="submitedthanks.php" method='POST'>
            <p>Enter the name of the deceased</p>
            <input type="text" name="name" required placeholder="Donald Trump!!!">
            <p>Enter the reason why they are being canceled</p>
            <input type="text" name="reason" required placeholder="Is racist!">
